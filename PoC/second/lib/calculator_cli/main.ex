defmodule CalculatorCli.Main do
  @moduledoc """
  Command-line entry point for the calculator application.

  The module accepts two integer arguments, adds them through `Math.MathService`,
  and prints the result for shell usage.
  """

  alias CalculatorCli.Models.Input
